...
export default function Projects() {
  return (
    <section id="projects" className="py-16 px-4 md:px-8 max-w-7xl mx-auto w-full">
      {/* Section Header */}
      <ScrollReveal>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {projects.map((p, idx) => (
          <ScrollReveal key={p.title} delay={idx % 2 === 1 ? 140 : 0} className="h-full">
            <div className="neu-card p-6 md:p-7 flex flex-col justify-between h-full">
              <div>
                {/* Card Top Meta */}
